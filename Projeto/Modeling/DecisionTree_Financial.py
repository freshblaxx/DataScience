...
savefig(f'Projeto/Images/{file_tag}_dt_{eval_metric}_study.png')
show()
...
savefig(f'Projeto/Images/{file_tag}_dt_{params["name"]}_best_{params["metric"]}_eval.png')
show()

tree_filename: str = f"Projeto/Images/{file_tag}_dt_{eval_metric}_best_tree"
max_depth2show = 3
...
savefig(f"Projeto/Images/{file_tag}_dt_{eval_metric}_vars_ranking.png")
...
savefig(f"Projeto/Images/{file_tag}_dt_{eval_metric}_overfitting.png")