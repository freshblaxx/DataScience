...
savefig(f"Projeto/Modeling/Gradient Boosting/{file_tag}_gb_{eval_metric}_overfitting.png")
...
savefig(f"Projeto/Modeling/Gradient Boosting/{file_tag}_gb_{eval_metric}_vars_ranking.png")