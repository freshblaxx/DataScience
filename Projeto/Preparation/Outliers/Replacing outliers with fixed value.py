...
# Load data
file_tag = "Financial"
data: DataFrame = read_csv("/Users/dominikfrank/Desktop/University/Master/Semester 1/PII/Data Science/Code for Project/DataScience/class_financial distress.csv", na_values="", parse_dates=True, dayfirst=True
)
...
if [] != numeric_vars:
    ...
    # Save cleaned data
    df.to_csv(f"/Users/dominikfrank/Desktop/University/Master/Semester 1/PII/Data Science/Code for Project/DataScience/Projeto/Preparation/Outliers{file_tag}_replacing_outliers_cleaned.csv", index=False)
