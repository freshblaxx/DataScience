...
<<<<<<< HEAD
    df.to_csv(f"/Users/dominikfrank/Desktop/University/Master/Semester 1/PII/Data Science/Code for Project/DataScience/Projeto/Preparation{file_tag}_drop_outliers_cleaned_arrests.csv", index=False)
=======
    df.to_csv(f"Projeto\Preparation\Outliers/{file_tag}_drop_outliers_cleaned_arrests.csv", index=False)
>>>>>>> 49e94bb9eb1a5615fce9e7411d8fb6246b14a6a5
